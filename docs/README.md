...
The files under `docs/superpowers/` preserve the design and implementation history of the first skill pack release. They are project records rather than end-user documentation
